...
app.get('/callback', async (req, res) => {
    try {
        ...
        const tokenSet = await client.callback(
            'https://d84l1y8p4kdic.cloudfront.net', // This is your redirect URI
            params,
            {
...
app.get('/logout', (req, res) => {
    req.session.destroy();
    const logoutUrl = `https://cognito-idp.us-east-1.amazonaws.com/us-east-1_S7mzuryvG/logout?client_id=qd9ls1r6dde9413898tkhfuk9&logout_uri=https://d84l1y8p4kdic.cloudfront.net`;
...
app.get("/search/index.html", (req, resp) => {
